...
**Current baseline:** **`v121.0.0`** (Product Ladder **102+** complete at
**`v120.0.0`** / scale gate **`maidan-scale-1.0`**; **`v121.0.0`** is post-gate
hardening — Phase XXIV, no new gate tag). See [Scale-out & hardening](#scale-out--hardening-ladder-102) below for the 102–120 additions.
