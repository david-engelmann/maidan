...
- **Latest tag:** **`v183.0.0`** (post-gate hardening, Phase XXIV). Post-v155 four-arc program complete (156–178); a new **security-led four-arc program** is underway (arc A: security & correctness — 179 A2A RBAC, 180 DM-thread participant check, 181 EventKind parser unification, 182 audit-log coverage, 183 default-on rate limit + body cap). Arc A closes with 184 (dual-write atomicity).
