...
Updated at each cluster retro. **Baseline:** code on `main` after **Cluster 404** (`e5c83a2b`; latest release tag **`v402.0.0`** at `ca2ddd3`) (Product Ladder 102+ complete at `v120` / `maidan-scale-1.0`; post-gate hardening 121+; MCP `2026-07-28` 300–303, mail 304–306, Slack/GitHub projectors 307–312, SDKs 294–299, launch-prep 313–314, post-flagship audit 332–349). Reconciled against code at v126 (Cluster 127), v143 (Cluster 144), v273 (Cluster 273), v314 (2026-08-28 sweep), again at **v349** (2026-09-02 splice — the "Forward program" section below folds the workplace-product roadmap + the engineering-canon research round), after **Cluster 403** (2026-09-17), and after **Cluster 404** (2026-09-22 — Cluster 404 is merged; its tag remains maintainer-gated).
...
- **Current baseline (superseding the retained chronology below): Cluster 404 (member occupancy follows and manager digest) on `main`; target tag `v404.0.0` is pending the maintainer.** Five implementation PRs (#943/#944/#949/#947/#948) completed Wave 2 row #28 across durable same-workspace follows, access-filtered occupancy, lifecycle notifications, atomic approval-request events, and notification-derived per-channel manager rollups. See [[Retros/Cluster 404]].
