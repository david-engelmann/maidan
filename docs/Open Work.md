...
- **Latest tag:** **`v179.0.0`** (post-gate hardening, Phase XXIV). Post-v155 four-arc program complete (156–178); a new **security-led four-arc program** began at 179 (arc A: security & correctness).
