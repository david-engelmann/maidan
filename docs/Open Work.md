...
- **Latest merged: Cluster 366 (Wave 1 #14 — legal-hold / OTel gate / web-push / SCIM) on `main`; tags `v350.0.0`–`v366.0.0` pending the maintainer.** Wave 1 #14 shipped as four independent PRs (#717 T6 legal-hold, #718 H15 OTel feature-gate, #719 N1 web-push, #720 SCIM-as-OIDC-P3) — see [[Retros/Cluster 366]]. **Wave 1 #1–14 are all COMPLETE. Next: Wave 2** (H1 AG-UI is #17). *(v350–v366 tags not yet cut — a `git tag` triggers `release.yml` image builds; left for the maintainer.)*
