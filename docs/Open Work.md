...
- **Current baseline (superseding the retained chronology below): Cluster 407 (executable surface and hero-loop contracts), released as `v407.0.0`.** Four implementation PRs (#965/#966/#967/#968) close Wave 4 row #39 with independent UI/OpenAPI derivation, exhaustive event-producer dispositions, one signed-session HTTP-to-WebSocket proof, and normalized portable-frame goldens. See [[Clusters/Cluster 407]] and [[Retros/Cluster 407]]. **Prior: Cluster 406 is released as `v406.0.0`.**
