...
MCP tool count is **190**. There is **no** MCP create workspace / channel / thread / member. An MCP-only agent cannot bootstrap a hero demo. Seed via REST or CLI, then MCP for claim / wait / post / `transition_thread`.
