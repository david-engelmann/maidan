...
**Active:** **Cluster 22.0** — capabilities hardening → **`v22.0.0`**
(see [[Clusters/Cluster 22.0]]; ladder [[Clusters/Product Ladder 17-27]]).

**Recently closed:** **`v21.0.0`** — A2A agent transport ([[Retros/Cluster 21.0]]).
