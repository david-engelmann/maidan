...
**Active:** **Cluster 21.0** — A2A agent transport → **`v21.0.0`**
(see [[Clusters/Cluster 21.0]]; ladder [[Clusters/Product Ladder 17-27]]).

**Recently closed:** **`v20.0.0`** — message router ([[Retros/Cluster 20.0]]).
