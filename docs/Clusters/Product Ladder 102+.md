...
| **120** ✓ | Scale product gate | `v120.0.0` ✓ / `maidan-scale-1.0` ✓ | **`maidan-scale-1.0`** e2e: multi-replica suite (102–105) + perf budgets (109) + coverage floor (114) + clean `cargo deny` + bench baselines recorded |
