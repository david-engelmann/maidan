...
use maidan_bus::{BusItem, EventBus, PostgresBus, PostgresBusOptions};
...
#[tokio::test]
async fn polled_relay_delivers_to_subscribers_without_pg_notify() {
