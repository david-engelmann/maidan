...
#[tokio::test]
async fn ui_search_panel_is_present_in_static_shell() {
    ...
    let html = client
        ...
        .await
        .unwrap();
    assert!(html.contains(r#"data-tab="search""#));
    assert!(html.contains(r#"id="panel-search""#));
    assert!(html.contains(r#"id="run-search""#));
